	...
	<div id="skip-to-main-content"><a id="skip-to-main-link" href="" class="sr-only sr-only-focusable">Skip to main content</a></div>
	...
	<div class="search-mobile-wrapper search-mobile-wrapper-hidden" id="search-mobile-wrapper"><input id="txtMobileSearch" type="text" class="search-input st-default-search-input" title="Search-box" alt="Search" placeholder="Search" aria-label="" autocomplete="off" autocorrect="off" autocapitalize="off"></div>
