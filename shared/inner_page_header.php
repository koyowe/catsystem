	<div class="hf-aura-wrapper">
		<div id="hf-aura" class="hf-aura no-print" no-print-web-checkin="">
			<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 237.436 119.988" enable-background="new 0 0 237.436 119.988" xml:space="preserve" preserveAspectRatio="xMinYMin meet">
			...
			</svg><img src="../images/pages/moh_kenya.png" width="100px">				
		</div>
	</div>
							
							
		<div class="show-only-in-public new-version">
			...
			<div id="headerNewStyle" class="" style="background-color:green">
				<div id="hf-nav-mobile" class="hf-nav-mobile menu-mobile">
					...
					<div id="hf-nav-top" class="pure-menu pure-menu-horizontal hf-nav-top" role="navigation">
					</div>
					
					<div id="nav-mobile-menu" class="pure-menu hidden nav-mobile-menu">
					...
					<ul class="menu-list nav-ul">
				
					</ul></div>
					
					
					<div id="hf-nav" class="hf-nav-test pure-menu pure-menu-horizontal" style="width:90%">
						...
						<ul class="pure-menu-list nav-ul" role="menu" style="width:180px;">
							...
							<a href="login.php?logout=true" style="cursor:pointer" class="pure-menu-link no-hover-underline" aria-label="Go to CATSystem Home">
								 ...
								 <table align="left">
									<tr>
										<td>
											<img src="../images/icons/logout.png" width="40px"> <span style="font-size:11px">Logout</span>
										</td>
									</tr>
								</table>
		...
		<div style="background-color:white">
			<div id="mobileBanner" class="container" style="width:90%; text-align:left;background-color:white; border-bottom:1px solid pink">
				<table  width="100%">
					<tr>
						<td style="width:50%; text-align:left">
							<span style="font-weight:bold;font-size:14px; text-shadow:1px 1px 5px rgba(12,0,0,.4);">
								[15288]
							</span>
							<span style="font-weight:bold;font-size:14px; text-shadow:1px 1px 5px rgba(12,0,0,.4);">
						...
						<td style="width:50%; text-align:right">
							<span>
								<img src="../images/icons/user.png" width="25px">
							</span>
							<span style="font-weight:bold;font-size:12px;">
								Dr. Clifford Njoroge William
							</span>
							<br/>
							<span style="font-weight:;font-size:10px;">
								Clinical Officer
							</span>
						</td>
					</tr>
			...
			<div id="desktopBanner" class="container" style="width:90%; text-align:left;background-color:white; border-bottom:1px solid pink">
				<table width="100%">
					<tr>
						<td style="width:50%; text-align:left">
							<span style="font-weight:bold;font-size:18px; text-shadow:1px 1px 5px rgba(12,0,0,.4);">
								[15288]
							</span>
							<span style="font-weight:bold;font-size:18px; text-shadow:1px 1px 5px rgba(12,0,0,.4);">
								Nakuru Provincial General Hospital
