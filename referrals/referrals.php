			...
			<div class="wrap">
			   ...
			   <div>
					<table id="searchResult" width="100%" cellspacing="0" style="background:white;border-collapse:collapse;">
						...
						<tr onclick="window.location.href = 'referral_encounters.php';">
							<td>
								CATS007
							</td>
							<td>
							...
							<td>
								<img src="../images/icons/upload.png" style="width:25px">
							</td>
							<td>
								Referred To
							</td>
						...
						<tr>
							...
							<td>
								<img src="../images/icons/download.png" style="width:25px">
							</td>
							<td>
								Referred From
							</td>
			   ...
			   <div id="enrollmentDiv" style="display:none">
					No referrals were found for that patient.
					<br>
					<a class="button button-orange" style="text-decoration:none" onclick="window.location.href = '../patients/find_patient.php?enrollmentStatus=new';">
					  Find a Patient to Refer
					</a>
				</div>
			</div>
