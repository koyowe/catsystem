	...
	<html lang="en">
		...
		<body>
			<div id="patientDetails">
				<table width="100%" style="border-collapse:collapse;">
					<tr>
						...
						<td style="width:;border-bottom:1px solid pink;">
							Patient Encounters
						</td>
					</tr>
				</table>
			...
			<div id="patientWidgets" style="background-color:white; height:100vh">
				...
				<div id="encounterMenu" style="border: 1px solid #dddddd;border-top: none;">
					<ul id="encounterList" style="display: inline-block;border: 1px solid #cccccc;border-left: none;list-style: none;margin-block-start: 1em;margin-block-end: 1em;margin-inline-start: 0px;margin-inline-end: 0px;padding-inline-start: 0px;">
